 ...
 */
 ...
 // END STEP 2.9
     ...
     function add_my_menus() {
        register_nav_menus(
        array(
            'header-menu' => __( 'Header Menu', 'preston-mrowczynski' ),
            'footer-menu' => __( 'Footer Menu', 'preston-mrowczynski' ),
            'social-menu' => __( 'Social Menu', 'preston-mrowczynski'),
    ...
    function billypoppins_theme_init(){
        ...
        add_action('after_setup_theme', 'preston-mrowczynski_theme_init');

        // END STEP 2.14 ADD ADDITIONAL CUSTOM FEATURES TO THE SITE THEME
            // START STEP 2.24 ADDING WIDGET SUPPORT

    function preston-mrowczynski_widgets_init() {
    ...
    add_action( 'widgets_init', 'preston-mrowczynski_widgets_init' );
